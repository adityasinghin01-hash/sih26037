...
alias = dictionary( ...
    ["autorickshaw", "auto rickshaw", "rickshaw", "motorcycle", "bike", "person", ...
     "animal", "cattle", "traffic sign", "trafficsign", "caravan", "trailer", "cart"], ...
    ["auto-rickshaw", "auto-rickshaw", "auto-rickshaw", "motorbike", "motorbike", ...
     "pedestrian", "cow", "cow", "static obstacle", "static obstacle", ...
     "van", "truck", "pushcart"]);

% DELIBERATELY NOT MAPPED, so they are dropped and COUNTED rather than taught as something
% they are not:
%   "vehicle fallback" - an unusual VEHICLE in IDD, not a static obstacle. Mapping it to
%                        ClassID 15 would teach the detector that lorries are walls.
%   "rider"            - a PERSON on a two-wheeler. IDD labels the rider and the vehicle
%                        separately, so folding rider into motorbike double-counts every
%                        two-wheeler and inflates that class against every other.
